...
public class BurstSolver : MonoBehaviour
{
    [Header("File Setup")]
    ...
    void Start()
    {
        ...
        {
            Debug.LogError($"[BurstSolver] Falhou em carregar o arquivo");
        }

        int vertexCount = loader.vertices.Length;
        Debug.Log($"[BurstSolver] Foram carregados {vertexCount} vertices");
        ...
        Debug.Log($"[BurstSolver] Foram carregados {edgeCount} arestas unicas");
        ...
        Debug.Log($"[BurstSolver] Foram carregados {tetraCount} tetraedros");
    ...
    void OnDrawGizmos()
    {
        ...
        for (int i = 0; i < positions.Length; i++)
        {
            ...
            // THE SHIELD: If physics exploded, skip drawing to prevent Unity from freezing!
